...
if(isset($_GET['query'])){
    ...
    $result = $engine->searchWeb($q, $page);

    $relatedSearch = $result["relatedSearch"];
    $results = $result["value"];
    $totalPages = $result["totalCount"] % 10;
...
<head>
    ...
    <title>Search Result for - <?php echo $q;?></title>
                ...
                <div class="related_searches">
                    ...
                    $link = str_replace(['<b>', '</b>'], '', $related) ;
                        ...
                        <div class="col-md-6 related">
                            <a href="search.php?query=<?php echo $link;?>" class="w-100 m-0">
                ...
                <div class="page_pagination">
                    ...
                    <?php for ($i=1; $i < 6; $i++) : ?>
                        <li class="<?php echo $i == $Cpage ? 'active' : '' ;?>">
                            <a href="search.php?query=<?php echo $q;?>&pg=<?php echo $i;?> "><?php echo $i;?></a>
                        </li>
                    <?php endfor; ?>
                    <li class="next">
                        <a href="search.php?query=<?php echo $q;?>&pg=<?php echo $page + 1;?>">Next</a>
                    </li>
                    <?php else:?>
